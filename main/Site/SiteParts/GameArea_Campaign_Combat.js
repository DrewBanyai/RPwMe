...
const GameAreaCampaignCombat = {
  create () {
    const container = Container.create({ id: 'GameArea_Campaign_Combat', style: STYLE.GAME_AREA_CAMPAIGN_SUBMENU })
...
//  Module Exports
module.exports = { GameAreaCampaignCombat }
