...
let GameArea_Campaign_Combat = {
    create() {
        let container = Container.create({ id: "GameArea_Campaign_Combat", style: STYLE.GAME_AREA_CAMPAIGN_SUBMENU, });
...
//  Module Exports
module.exports = { GameArea_Campaign_Combat }