...
const CampaignController = {
  ...
  GetPlayer (playerUsername) {
    ...
    for (let i = 0; i < 3; ++i) {
      if (CAMPAIGN_DATA.Players[i] && CAMPAIGN_DATA.Players[i].playerUsername === playerUsername) { return CAMPAIGN_DATA.Players[i] }
    }
  },
  GetPlayerExists (playerUsername) {
    ...
    for (let i = 0; i < 3; ++i) {
      if (CAMPAIGN_DATA.Players[i] && CAMPAIGN_DATA.Players[i].playerUsername === playerUsername) { return true }
    }
    return false
  },
