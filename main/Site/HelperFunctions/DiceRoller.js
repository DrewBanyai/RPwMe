...
const DiceRoller = {
    ...
    */
    RollString: (diceString) => {
        let dPosition = diceString.indexOf("d");
        ...
        if (dPosition != 0) {
            ...
            let diceCountString = diceString.substr(0, dPosition);
        ...
        let diceTypeString = diceString.substr(dPosition + 1, diceString.length - (dPosition + 1));
        ...
        let diceType = parseInt(diceTypeString);
